...
def root() -> dict[str, Any]:
    return {
        "service": "NEOcortex Local API",
        "status": "ok",
        "hint": "This is API root, not UI. Open /docs for Swagger UI.",
        "ui_hint": "Run zero-room-web separately on http://127.0.0.1:4173",
        "endpoints": [
            "/health",
            "/zero-room/status",
            "/ingestion/import-seed",
            "/map",
            "/entourage/reply",
            "/docs",
        ],
